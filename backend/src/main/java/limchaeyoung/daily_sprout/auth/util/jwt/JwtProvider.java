...
import limchaeyoung.daily_sprout.common.redis.util.RedisUtil;
...
import static limchaeyoung.daily_sprout.common.exception.ErrorCode.*;
...
public class JwtProvider {
    ...
    public void validateRefreshToken(String refreshToken) {
        ...
        if (!redisUtil.get(key).equals(refreshToken)) {
            ...
            throw new CustomSecurityException(REFRESH_TOKEN_MISMATCH);
        }
    }
